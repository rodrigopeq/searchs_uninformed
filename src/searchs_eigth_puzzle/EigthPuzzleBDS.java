...
public class EigthPuzzleBDS {
	
	//***Par�metros: board inicial do quebra cabe�a.***//
	//***Retorno: nulo.***//
	public static void quebraHead8BDSfunction (EightPuzzleBoard inicial) {
		System.out.println("\nQuebra cabeca de 8 pecas (BDS)\n");
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(inicial);
			SearchForActions<EightPuzzleBoard, Action> search = new BreadthFirstSearch<>(new BidirectionalSearch<EightPuzzleBoard, Action>());
